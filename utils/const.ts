...
export default {
    ...
    SEED_FILE: process.env.UMBREL_SEED_FILE || process.env.SEED_FILE || '/db/umbrel-seed/seed',
    DASHBOARD_HIDDEN_SERVICE_FILE: process.env.UMBREL_DASHBOARD_HIDDEN_SERVICE_FILE || process.env.DASHBOARD_HIDDEN_SERVICE_FILE || '/var/lib/tor/web/hostname',
    ...
    VERSION_FILE: process.env.UMBREL_VERSION_FILE || process.env.VERSION_FILE  || '/info.json',
